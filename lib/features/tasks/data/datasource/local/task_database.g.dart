...
class TaskTableData extends DataClass implements Insertable<TaskTableData> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, title, description, status, createdAt, userId);
  @override
...
abstract class _$TaskDriftDatabase extends GeneratedDatabase {
  _$TaskDriftDatabase(QueryExecutor e) : super(e);
  $TaskDriftDatabaseManager get managers => $TaskDriftDatabaseManager(this);
...
class $$TaskTableTableFilterComposer
    extends Composer<_$TaskDriftDatabase, $TaskTableTable> {
...
class $$TaskTableTableTableManager
    extends
        RootTableManager<
          ...
          (
            TaskTableData,
            BaseReferences<_$TaskDriftDatabase, $TaskTableTable, TaskTableData>,
          ),
          TaskTableData,
          PrefetchHooks Function()
        > {
  $$TaskTableTableTableManager(_$TaskDriftDatabase db, $TaskTableTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
...
class $TaskDriftDatabaseManager {
  final _$TaskDriftDatabase _db;
  $TaskDriftDatabaseManager(this._db);
